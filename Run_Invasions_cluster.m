...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Inputs (used to run simulations in the clauster)
...
function Run_Invasions_cluster(indxP,indxA,frG_native,frG_Inv,k_level,opW,ftauI,muAP,r_i,sem)

global J_pattern

rand('seed',sem+r_i);

M=load(sprintf('1200_networks/m%04d.txt',r_i));% r_i= 1 to 1200
